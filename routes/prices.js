...
router.get("/", getAdminSettings, preparePricesData, function renderPage(req, res, next) {
  return res.render("pages/prices/index");
});

router.get("/:boostType", getAdminSettings, preparePricesData, function renderPage(req, res, next) {
  if (
