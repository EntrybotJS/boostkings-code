...
router.post(
  ...
  function(req, res, next) {
    ...
    var create_payment_json = {
      ...
      redirect_urls: {
        return_url: "https://boostkings.lol",
        cancel_url: "https://boostkings.lol",
      },
      transactions: [
        {
          item_list: {
            items: [
              {
                ...
                price: boostOrder.discountedPrice || boostOrder.price,
                currency: "USD",
                quantity: 1,
              },
            ],
      ...
      if (error) {
        ...
        res.locals.newOrder.save(function(err, savedOrder) {
          if (err) {
            console.log(err);
            // TODO: refund order
            return res.status(500).send("There was an error while saving your order.");
          } else {
            ...
            var subject = "Boost Kings - Order Confirmation #" + savedOrder.confirmationNumber.toUpperCase();
              ...
              html: pug.renderFile("views/emails/template.pug", {
                ...
                paragraphs: [
                  ...
                  "<b>Confirmation number</b>: <code>" +
                    ...
                    "<br>" +
                    "<b>Order date</b>: " +
                    moment(savedOrder.created_on).format("LLLL"),
            ...
            smtpTransport.sendMail(mailOptions, function(err) {
              var response = {
                ...
                created_on: moment(savedOrder.created_on).format("LLLL"),
              };
