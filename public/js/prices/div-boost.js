(function(window, document, $) {
  ...
  ************************************/
  divisionBoost.cacheSelectors = function() {
    divisionBoost._currentDivisions = document.getElementById("division-boost-current-division");
    divisionBoost._currentTier = document.getElementById("division-boost-current-tier");
    divisionBoost._currentLP = document.getElementById("division-boost-current-lp");
    divisionBoost._requestedTier = document.getElementById("division-boost-requested-tier");
    divisionBoost._requestedDivisions = document.getElementById("division-boost-requested-division");
  };
  ...
  ************************************/
  divisionBoost.unleashDragons = function() {
    ...
    $(divisionBoost._currentTier).on("change", function() {
      ...
      $(divisionBoost._currentDivisions).html(currentDivisionsClone.html());
      ...
      if (divisionBoost._currentTier.selectedIndex > divisionBoost._requestedTier.selectedIndex) {
        $(divisionBoost._requestedTier)
          .find("option")
          .each(function(index) {
            if (index == divisionBoost._currentTier.selectedIndex) return false;
            $(this).remove();
          });
      }
    ...
    var requestedDivisionsClone = $(divisionBoost._requestedDivisions).clone();
    $(divisionBoost._requestedTier).on("change", function() {
      ...
      $(divisionBoost._requestedDivisions).html(requestedDivisionsClone.html());
    ...
    $(divisionBoost._currentDivisions).on("change", function() {
      ...
      if (
        $(divisionBoost._currentTier).val() == $(divisionBoost._requestedTier).val() &&
        divisionBoost._currentDivisions.selectedIndex > divisionBoost._requestedDivisions.selectedIndex
      ) {
        $(divisionBoost._requestedDivisions)
          .find("option")
          .each(function(index) {
            if (index == divisionBoost._currentDivisions.selectedIndex) return false;
            $(this).remove();
          });
      }
      $(divisionBoost._requestedDivisions).trigger("change");
  ...
  ************************************/
  divisionBoost.updatePrice = function() {
    var currentDivisionAtomicPrice =
      $("option:selected", $(divisionBoost._currentDivisions)).attr("atomicPrice") ||
      $("option:selected", $(divisionBoost._currentDivisions))
        .next()
        .attr("atomicPrice");
    var regularPriceCur = $("option:selected", $(divisionBoost._currentDivisions)).attr("regularPrice");
    var regularPriceReq = $("option:selected", $(divisionBoost._requestedDivisions)).attr("regularPrice");
    var regularFinalPrice = regularPriceReq - regularPriceCur;

    // LP selection
    if ($("#division-boost-current-lp").length) {
      regularFinalPrice -= currentDivisionAtomicPrice * parseFloat($("#division-boost-current-lp").val());
  ...
  ************************************/
  divisionBoost.updateImage = function(select) {
    ...
    var imgRequested = document.getElementById("division-boost-img-requested");
    var img = select.id == "division-boost-current-tier" ? imgCurrent : imgRequested;
