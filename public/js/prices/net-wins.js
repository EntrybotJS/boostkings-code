$(document).ready(function() {
  ...
  var updateImage = function(select) {
    ...
    } else if (select.options[select.selectedIndex].text.includes("Bronze")) {
      img.src = "/img/tiers/bronze.png";
    } else if (select.options[select.selectedIndex].text.includes("Silver")) {
      img.src = "/img/tiers/silver.png";
    } else if (select.options[select.selectedIndex].text.includes("Gold")) {
      img.src = "/img/tiers/gold.png";
    } else if (select.options[select.selectedIndex].text.includes("Platinum")) {
      img.src = "/img/tiers/platinum.png";
    } else if (select.options[select.selectedIndex].text.includes("Diamond")) {
      img.src = "/img/tiers/diamond.png";
    } else if (select.options[select.selectedIndex].text.includes("Master")) {
